...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="Đây là mô hình chuyển văn bản thành giọng nói cho tiếng Việt",
    ...
    parser.add_argument(
        "-p", "--preprocess_config",
        type=str,
        default="./config/my_data/preprocess.yaml",
        help="path to preprocess.yaml",
    )
    parser.add_argument(
        "-m", "--model_config", 
        type=str, 
        default="./config/my_data/model.yaml", 
        help="path to model.yaml"
    )
    parser.add_argument(
        "-t", "--train_config", 
        type=str, 
        default="./config/my_data/train.yaml", 
